...
namespace Confuser.Protections
{
    ...
    internal class JunkDump : Protection
    {
        ...
        private class JunkDumpPhase : ProtectionPhase
        {
            ...
            {
                const string chars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRST123456789他是说汉语的Ⓟⓡⓞⓣⓔⓒⓣｱ尺Ծｲ乇ζｲ123456789αβγδεζηθικλμνξοπρστυφχψω卍卍卍卍卍卍卍";
            ...
            protected override void Execute(ConfuserContext context, ProtectionParameters parameters)
            {
                foreach (ModuleDef moduleDef in parameters.Targets.OfType<ModuleDef>())
                {
                    ...
                    {
                        moduleDefMD.Name = "_-<<卐TRINITY_OBFUSCATOR卍>>-_";
                        moduleDefMD.Assembly.Name = "_-<<卐TRINITY_OBFUSCATOR卍>>-_";
                        ...
                        for (int i = 0; i <= num; i++)
                        {
                            for (int j = 0; j <= 50; j++)
                            {
                                ...
                                new TypeDefUser(Random(15) + "_-<<卐TRINITY_OBFUSCATOR卍>>-_", Random(rnd.Next(1, 20)) + "<Module>", moduleDefMD.CorLibTypes.Object.TypeDefOrRef).Attributes = TypeAttributes.Public;
                                TypeDef item = new TypeDefUser(Random(rnd.Next(1, 25)) + "<Module>", Random(rnd.Next(1, 15)) + "_-<<卐TRINITY_OBFUSCATOR卍>>-_", moduleDefMD.CorLibTypes.Object.TypeDefOrRef)
                                {
                                    Attributes = TypeAttributes.Public
                                };
                                TypeDef item2 = new TypeDefUser(Random(rnd.Next(1, 20)) + "_-<<卐TRINITY_OBFUSCATOR卍>>-_", Random(rnd.Next(1, 15)) + "<Module>", moduleDefMD.CorLibTypes.Object.TypeDefOrRef)
                                {
                                    Attributes = TypeAttributes.Public
                                };
                            ...
                            moduleDefMD.EntryPoint.Name = Random(rnd1.Next(1, 10)) + "_-<<卐TRINITY_OBFUSCATOR卍>>-_" + Random(300) + "_-<<卐TRINITY_OBFUSCATOR卍>>-_" + Random(rnd1.Next(1, 10));
                        }
                    }
                    else
                    {
