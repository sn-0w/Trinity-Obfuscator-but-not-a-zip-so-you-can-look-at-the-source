	...
	public partial class MainWindow : Window {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            using (var wc = new WebClient())
            {
                ...
                try
                {
                    switch (wc.DownloadString("https://api.trinity-obfuscator.us/cli/version.txt"))
                    {
                        case "1.1":
                        ...
                        default:
                            ...
                            Process.Start(wc.DownloadString("https://api.trinity-obfuscator.us/download.txt"));
                            break;
                    }
                }
                catch (Exception ex)
        ...
        {
            Process.Start("https://discord.gg/NeU3hjb");
        }
    }
}